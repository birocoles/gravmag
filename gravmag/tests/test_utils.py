...
def test_safe_atan2():
    ...
    # First quadrant
    x, y = 1, 1
    aae(utils.safe_atan2_np(y, x), np.pi / 4, decimal=15)
    # Second quadrant
    x, y = -1, 1
    aae(utils.safe_atan2_np(y, x), -np.pi / 4, decimal=15)
    # Third quadrant
